 ...
 * AT Theme.
 *
 * This file adds gulp tasks to the AT theme.
 *
 * @author Seo themes
 */
...
// Set assets paths.
var paths = {
	images:  ['resource/assets/images/*', 'resource/!assets/images/*.svg'],
	php:     ['./*.php',  './**/*.php', './**/**/*.php'],
	scripts: ['resource/assets/js/*.js', 'resource/!assets/scripts/min/'],
	styles:  ['resource/assets/scss/*.scss', 'resource/!assets/styles/min/']
};
...
gulp.task('styles', function () {
	...
	gulp.src('assets/styles/woocommerce.scss')
		...
		.pipe(gulp.dest('assets/scss/min/'))
	...
	gulp.src('resources/assets/scss/style.scss')
		...
		// Write source map.
		.pipe(sourcemaps.write('resources/assets/scss/'))

		// Output the compiled sass to this directory.
		.pipe(gulp.dest('resources/assets/scss/min'))
...
gulp.task('scripts', function () {
	...
	gulp.src(paths.scripts)
		...
		.pipe(gulp.dest('resources/assets/scripts/min'))
...
gulp.task('zip', function () {
	...
	gulp.src([root + '**/*', root + '!node_modules/', root + '!node_modules/**', root + '!aws.json'])
